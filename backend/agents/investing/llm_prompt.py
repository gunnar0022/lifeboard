...
CRITICAL: When the user asks to add, delete, edit, or record something, you MUST return the specific action — NOT "respond". Using "respond" does nothing to the database.
