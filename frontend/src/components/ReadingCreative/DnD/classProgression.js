...
export const CLASS_PROGRESSION = {
  ...
  Monk: [
    { id: 'mnk-unarmored-defense', name: 'Unarmored Defense', level: 1, source: 'Monk',
      desc: 'While wearing no armor and no shield, your AC equals 10 + Dexterity modifier + Wisdom modifier.' },
    { id: 'mnk-martial-arts', name: 'Martial Arts', level: 1, source: 'Monk', combat: true,
    ...
    { id: 'mnk-ki', name: 'Ki', level: 2, source: 'Monk', combat: true,
    ...
    { id: 'mnk-unarmored-movement', name: 'Unarmored Movement', level: 2, source: 'Monk',
    ...
    { id: 'mnk-asi-4', name: 'Ability Score Improvement', level: 4, source: 'Monk', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat.' },
    { id: 'mnk-slow-fall', name: 'Slow Fall', level: 4, source: 'Monk',
      desc: 'Reaction when you fall: reduce the falling damage by five times your monk level.' },
    { id: 'mnk-quickened-healing', name: 'Quickened Healing (Optional)', level: 4, source: 'Monk',
      desc: 'Action: spend 2 ki and roll a Martial Arts die to regain HP equal to the roll + your proficiency bonus.' },
    { id: 'mnk-extra-attack', name: 'Extra Attack', level: 5, source: 'Monk',
      desc: 'You can attack twice whenever you take the Attack action on your turn.' },
    { id: 'mnk-stunning-strike', name: 'Stunning Strike', level: 5, source: 'Monk', combat: true,
    ...
    { id: 'mnk-focused-aim', name: 'Focused Aim (Optional)', level: 5, source: 'Monk',
    ...
    { id: 'mnk-ki-empowered', name: 'Ki-Empowered Strikes', level: 6, source: 'Monk',
      desc: 'Your unarmed strikes count as magical for overcoming resistance and immunity to nonmagical damage.' },
    { id: 'mnk-evasion', name: 'Evasion', level: 7, source: 'Monk',
      desc: 'When you make a Dexterity save for half damage, you instead take no damage on a success and half on a failure.' },
    { id: 'mnk-stillness', name: 'Stillness of Mind', level: 7, source: 'Monk',
      desc: 'Action: end one effect on yourself causing you to be charmed or frightened.' },
    { id: 'mnk-asi-8', name: 'Ability Score Improvement', level: 8, source: 'Monk', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat.' },
    { id: 'mnk-purity', name: 'Purity of Body', level: 10, source: 'Monk',
      desc: 'You are immune to disease and poison.' },
    { id: 'mnk-asi-12', name: 'Ability Score Improvement', level: 12, source: 'Monk', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat.' },
    { id: 'mnk-tongue', name: 'Tongue of the Sun and Moon', level: 13, source: 'Monk',
      desc: 'You understand all spoken languages, and any creature that knows a language can understand you.' },
    { id: 'mnk-diamond-soul', name: 'Diamond Soul', level: 14, source: 'Monk',
      desc: 'You gain proficiency in all saving throws, and can spend 1 ki to reroll a failed save (taking the second result).' },
    { id: 'mnk-timeless-body', name: 'Timeless Body', level: 15, source: 'Monk',
      desc: 'You no longer age, can\'t be magically aged, and need no food or water.' },
    { id: 'mnk-asi-16', name: 'Ability Score Improvement', level: 16, source: 'Monk', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat.' },
    { id: 'mnk-empty-body', name: 'Empty Body', level: 18, source: 'Monk', combat: true,
    ...
    { id: 'mnk-asi-19', name: 'Ability Score Improvement', level: 19, source: 'Monk', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat.' },
    { id: 'mnk-perfect-self', name: 'Perfect Self', level: 20, source: 'Monk',
      desc: 'When you roll initiative with no ki points remaining, you regain 4 ki points.' },
  ],

  Paladin: [
    { id: 'pal-divine-sense', name: 'Divine Sense', level: 1, source: 'Paladin', combat: true,
    ...
    { id: 'pal-lay-on-hands', name: 'Lay on Hands', level: 1, source: 'Paladin', combat: true,
    ...
    { id: 'pal-fighting-style', name: 'Fighting Style', level: 2, source: 'Paladin', choice: 'fighting-style',
      desc: 'Adopt a fighting style as your specialty. (Blessed Warrior grants two cleric cantrips cast with Charisma.)' },
    { id: 'pal-spellcasting', name: 'Spellcasting', level: 2, source: 'Paladin',
    ...
    { id: 'pal-divine-smite', name: 'Divine Smite', level: 2, source: 'Paladin', combat: true,
    ...
    { id: 'pal-asi-4', name: 'Ability Score Improvement', level: 4, source: 'Paladin', choice: 'asi',
    ...
    { id: 'pal-extra-attack', name: 'Extra Attack', level: 5, source: 'Paladin',
      desc: 'You can attack twice whenever you take the Attack action on your turn.' },
    { id: 'pal-aura-protection', name: 'Aura of Protection', level: 6, source: 'Paladin', combat: true,
    ...
    { id: 'pal-asi-8', name: 'Ability Score Improvement', level: 8, source: 'Paladin', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat. Martial Versatility (optional): instead replace a fighting style with another.' },
    { id: 'pal-aura-courage', name: 'Aura of Courage', level: 10, source: 'Paladin',
      desc: 'While conscious, you and friendly creatures within 10 ft (30 ft at 18th) can\'t be frightened.' },
    { id: 'pal-improved-smite', name: 'Improved Divine Smite', level: 11, source: 'Paladin', combat: true,
      desc: 'Your melee weapon hits deal an extra 1d8 radiant damage.' },
    { id: 'pal-asi-12', name: 'Ability Score Improvement', level: 12, source: 'Paladin', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat. Martial Versatility (optional): instead replace a fighting style with another.' },
    { id: 'pal-cleansing-touch', name: 'Cleansing Touch', level: 14, source: 'Paladin', combat: true,
    ...
    { id: 'pal-asi-16', name: 'Ability Score Improvement', level: 16, source: 'Paladin', choice: 'asi',
      desc: 'Increase one ability score by 2, or two by 1 (max 20) — or take a feat. Martial Versatility (optional): instead replace a fighting style with another.' },
    { id: 'pal-aura-improvements', name: 'Aura Improvements', level: 18, source: 'Paladin',
