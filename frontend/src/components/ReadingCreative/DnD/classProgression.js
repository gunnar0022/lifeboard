  ...
  'Assassin': {
    ...
    features: [
      ...
      { id: 'as-infiltration', name: 'Infiltration Expertise', level: 9, source: 'Assassin',
        desc: 'You can unfailingly create false identities. Spend 7 days and 25 gp to establish the history, profession, and affiliations for an identity. You can\'t establish an identity that belongs to someone else.' },
      { id: 'as-impostor', name: 'Impostor', level: 13, source: 'Assassin',
        desc: 'You can unerringly mimic another person\'s speech, writing, and behavior after studying them for at least 3 hours. You have advantage on Charisma (Deception) checks to avoid detection.' },
