...
export const SUBCLASS_LISTS = {
  ...
  Wizard: [
    { name: 'School of Abjuration', implemented: true },
    { name: 'School of Conjuration', implemented: true },
    { name: 'School of Divination', implemented: true },
    { name: 'School of Enchantment', implemented: true },
    { name: 'School of Evocation', implemented: true },
    { name: 'School of Illusion', implemented: true },
    { name: 'School of Necromancy', implemented: true },
    { name: 'School of Transmutation', implemented: true },
    { name: 'Bladesinging', implemented: true },
    { name: 'War Magic', implemented: true },
    { name: 'Chronurgy Magic', implemented: true },
    { name: 'Graviturgy Magic', implemented: true },
    { name: 'Order of Scribes', implemented: true },
  ],
  Druid: [
  ...
  Cleric: [
    { name: 'Arcana Domain', implemented: true },
    { name: 'Knowledge Domain', implemented: true },
    { name: 'Life Domain', implemented: true },
    { name: 'Light Domain', implemented: true },
    { name: 'Nature Domain', implemented: true },
    { name: 'Tempest Domain', implemented: true },
    { name: 'Trickery Domain', implemented: true },
    { name: 'War Domain', implemented: true },
    { name: 'Death Domain', implemented: true },
    { name: 'Forge Domain', implemented: true },
    { name: 'Grave Domain', implemented: true },
    { name: 'Order Domain', implemented: true },
    { name: 'Peace Domain', implemented: true },
    { name: 'Twilight Domain', implemented: true },
  ],
  Paladin: [
  ...
  Warlock: [
    ...
    { name: 'The Fiend', implemented: true },
    { name: 'The Great Old One', implemented: true },
    { name: 'The Celestial', implemented: true },
    { name: 'The Hexblade', implemented: true },
    { name: 'The Fathomless', implemented: true },
    { name: 'The Genie', implemented: true },
    { name: 'The Undead', implemented: true },
    { name: 'The Undying', implemented: true },
  ],
  Sorcerer: [
